...
async def get_destination_by_id(destination_id: uuid.UUID, db: AsyncSession) -> Destination:
...
async def delete_destination(destination_id: uuid.UUID, db: AsyncSession) -> None:
